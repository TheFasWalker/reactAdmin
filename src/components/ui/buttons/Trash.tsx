...
export const Trash: FC<ButtonProps> = () => {
    ...
    return (
        <>
            ...
            <button onClick={openConfirmPopup} className="bg-red-400 h-10 w-10 rounded-lg flex items-center justify-center group hover:bg-red-600">
                <svg className="w-8 h-8 text-gray-800 dark:text-white fill-slate-400  group-hover:fill-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
